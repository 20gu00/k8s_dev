...
type SharedInformer interface {
	...
	// 获取一个 Controller,主要是用来将 Reflector 和 DeltaFIFO 组合到一起工作
	...
	// 最新同步资源的版本(每次操作资源版本都会变化,注意这个不是api的version)
...
// todo 在 SharedInformer 基础上扩展了添加和获取 Indexers 的能力
...
type sharedIndexInformer struct {
	// todo Indexer也是一种Store，，Controller负责把Reflector和FIFO逻辑串联起来
