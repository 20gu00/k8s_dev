...
// todo Object Object interface must be supported by all API types registered with Scheme
// todo 操作资源和 apiserver 进行通信的时候，需要根据资源对象类型的 Group、Version、Kind 以及规范定义、编解码等内容构成 Scheme 类型，然后 Clientset 对象就可以来访问和操作这些资源类型
// todo 是schema类型就得实现Object
// todo type.go的比如deployment的结构体就实现了GetObjectKind方法,
// todo 资源实现的DeepCopyObject deepcopy-gen代码生成器自动生成
// todo 所以资源实现了Object
